 ...
 */
final class Version20200328132137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE joueur (id_joueur INT AUTO_INCREMENT NOT NULL, prenom_joueur VARCHAR(50) DEFAULT NULL, nom_joueur VARCHAR(50) NOT NULL, capitaine VARCHAR(3) NOT NULL, id_equipe INT NOT NULL, poste_joueur VARCHAR(11) NOT NULL, PRIMARY KEY(id_joueur)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
